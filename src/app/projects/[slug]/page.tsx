    ...
    gallery: [
      {
        ...
        alt: 'Castle animation',
        caption: 'Interactive Disney castle animation',
      },
      {
        type: 'gif',
        url: '/creations/disney/animation2.gif',
        alt: 'Animated characters',
        caption: 'Disney characters in augmented reality',
      },
      {
        type: 'image',
      ...
      },
      {
        ...
        alt: 'Project demo',
        caption: 'Complete experience demonstration',
      },
      {
        type: 'gif',
        url: '/creations/disney/animation3.gif',
        alt: 'Special effects',
        caption: 'Special effects during night attractions',
      },
    ],
    nextProject: 'test',
