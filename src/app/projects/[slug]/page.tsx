    ...
    >
      ...
      <div className="sticky top-0 z-40 flex w-full items-center justify-between bg-black/10 p-4 backdrop-blur-md">
        <a
          ...
          className="flex items-center text-sm font-semibold text-neutral-900 transition-colors [text-shadow:0_0_5px_rgba(255,255,255,0.95),0_1px_3px_rgba(0,0,0,0.35)] hover:text-black md:text-base"
        >
          ← Back to creations
        </a>
        ...
        <div className="flex gap-4">
          {project.previousProject && (
            <a
              ...
              className="text-sm font-semibold text-neutral-900 transition-colors [text-shadow:0_0_5px_rgba(255,255,255,0.95),0_1px_3px_rgba(0,0,0,0.35)] hover:text-black md:text-base"
            >
              ← Previous project
            </a>
          )}
