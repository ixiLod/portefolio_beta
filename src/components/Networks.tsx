      ...
      loader.load(
        ...
        (error: unknown) => {
          if (error instanceof Error) {
            ...
            console.error(`An unknown error occurred while loading the ${modelName} model.`);
          }
        }
      );
    };

    loadModel('/assets/models/instagramLogo.gltf', setGltfModel1, gltfRef1, 'Instagram');
    loadModel('/assets/models/linktreeLogo.gltf', setGltfModel2, gltfRef2, 'Linktree');
    loadModel('/assets/models/githubLogo.gltf', setGltfModel3, gltfRef3, 'Github');
  }, []);
